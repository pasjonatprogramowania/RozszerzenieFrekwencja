    ...
    try {
        ...
        if (settings != undefined) {
            if (settings[0].sort == true) {
                document.querySelector('input[value="sort"]').setAttribute("checked", "checked");
            }
            if (settings[0].hightlight == true) {
                document.querySelector('input[value="hightlight"]').setAttribute("checked", "checked");
            }
            if (isFinite(settings[0].stateValue)) {
                document.querySelector('input[value="state"]').setAttribute("checked", "checked");
        ...
        document.querySelector("tbody").innerHTML = createTableSettings(objectFrequency);
        if (settings != undefined) {
            if (settings[0].hide == true && settings[0].lessonToHide.length != 0) {
                document.querySelector('input[value="hide"]').setAttribute("checked", "checked");
